    ...
    <div class="row">
        <div class="col-md-3 col-12">
            <div class="list-group m-4 style="background-color: #e3edfd;">
                <a href="adminAllItemPath.do" class="list-group-item list-group-item-action active"><i class="fa fa-shopping-basket me-1" style="color: #fa645e;"></i>Product Management</a>
                <a href="adminAllCategoryPath.do" class="list-group-item list-group-item-action" aria-current="true"><i class="fa fa-cubes me-1" style="color: #fa645e;"></i>Category Management</a>
        ...
        <div class="col-md-9 col-12 m-0 pt-3">
          ...
          <div class="row ms-md-0 ms-3">
              <div class="col-7">
                  <h2 class="d-inline-flex">All Products</h2>
              </div>
              <div class="col-5">
                  <div class="d-inline-flex float-end me-3">
                      <a href="adminItemAddPathFirst.do" type="button" class="btn btn-info mb-3 text-white"><i class="fa fa-plus me-1" style="color: #fcfcfc;"></i>Add New Product</a>
                  </div>
              </div>
          </div>
           
          <div class="item-table-container w-100"> 
            <table class="table table-striped display pt-3" id="table">
              <thead class="" style="background-color: #e3edfd;">
              	<tr class="thead">
              	  <th></th>
                  <th class="item-name text-center">Item</th>
                  <th class="text-center">Stock</th>
                  <th class="unit-price text-center">Unit Price</th>
                  <th class="item-description text-center">Description</th>
                  <th></th>
                  <th></th>
                </tr>
              </thead>
			...
			<tbody>
              	<logic:notEmpty property="itemsList" name="AdminItemFormBean">
					<logic:iterate id="item" property="itemsList" name="AdminItemFormBean">
                		<tr>
                  			<td class="text-center">
                    			<div class="img-container">
                      				<img src="${item.itemImage }" alt="productImage" height="100" width="100" />
                    			</div> 
                  			</td>
                  			<td class="item-name"> ${item.itemName }</td>
                  			<td class="text-center"> ${item.stock }</td>
                  			<td class="unit-price text-center">${item.unitPrice } ks</td>
                  			<td class="item-description">${item.description } </td>
                  			<td class="text-center"><a href="adminItemEditPathFirst.do?frmItemId=${item.id}"><i class="fa fa-pencil me-1" style="color: #fa645e;"></i></a></td>
                			<td><html:hidden property="frmItemId" value="${item.id}" />
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
												   <html:form action="/adminAllItemPath">
													<button type="button" class="btn btn-outline-danger"
														data-bs-dismiss="modal">Cancel</button>
													<html:hidden property="frmItemId" value="${item.id}" />
