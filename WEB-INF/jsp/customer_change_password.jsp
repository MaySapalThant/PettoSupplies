           ...
           <div class="row">
               <div class="col-md-2 col-12">
                <div class="list-group mb-5">
                    ...
                    <a href="changePasswordPathFirst.do" class="list-group-item list-group-item-action active" aria-current="true">Change Password</a>
                    <a href="customerOrderPath.do" class="list-group-item list-group-item-action">Orders</a>
               ...
               <div class="col-md-10 col-12">
                    <div class="ms-5 me-5">
                    <logic:notEmpty property="changePasswordAlert" name="ChangePasswordFormBean">
          				<div class="alert alert-success" role="alert">
  							${ChangePasswordFormBean.changePasswordAlert} 
						</div>
          			</logic:notEmpty>  
                    	<html:form action="/changePasswordPath">
                            ...
                            <div class="w-100 mb-4">
                            	<html:hidden property="frmUpdateId" value="${LoginFormBean.loginCustomer.id}"/>
                            	<html:submit property="btnChangePassword" styleClass="btn btn-red text-uppercase">Change</html:submit>
                            </div>
                    	</html:form>   
                    </div>
               </div>
