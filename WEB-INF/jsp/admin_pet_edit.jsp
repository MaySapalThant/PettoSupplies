    ...
    <div class="row">
        ...
        <div class="col-md-9 col-12 m-0 pt-3">
          ...
          <div class="row ms-md-0 ms-3">
              <div class="col-7">
                  <h2 class="d-inline-flex">Edit Pet</h2>
              </div>
              <div class="col-5">
          ...
          <logic:notEmpty property="frmPetName" name="AdminPetEditFormBean">
          		<div class="alert alert-success" role="alert">
  					${AdminPetEditFormBean.frmPetName}  ${AdminPetEditFormBean.alert} 
				</div>
          </logic:notEmpty>
          
          <div class="add-new-container container">
        	<html:form action="/adminPetEditPath" method="post" enctype="multipart/form-data">
        	
        	<html:errors property="frmPetName"/>
            <div class="form-floating mb-3">
            	<html:text property="frmPetName" styleClass="form-control form-control-sm" styleId="petName" value="${AdminPetEditFormBean.pet.petName}"></html:text>
            ...
            <html:hidden property="frmPetId" value="${AdminPetEditFormBean.pet.id}"/>
